...
SignalPortInputView::SignalPortInputView(const NodeView& parent,
                                         std::string name)
...
FloatInputView::FloatInputView(const NodeView& parent, std::string name,
                               ImVec2 range, float default_value)
    : NodeInputView{parent, std::move(name)},
      range_{range},
...
SignalPortOutputView::SignalPortOutputView(const NodeView& parent,
                                           std::string name)
